...
<body class = "container col-md-10" background="wpp2.png" style="font-family: Trebuchet MS">
    ...
    <br>
    <h1 class="text-white" style="border:3px solid #fff; border-radius:3px;padding:10px;"><b><center>Clientes da AutoPeças </center></b></h1>    <br>
    <br>
   <input type="button" id="btnAdd name="btnAdd" class="btn btn-success btn-lg" value=" Novo cliente"
    onclick="javascript:location.href='formInsCliente.html'">
    ...
    <?php 
        ...
        <tr>
            ...
            <td><b>R$<?php echo number_format($linha['Saldo'],2,',','.') ?></b></td>
